...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="rdf:Description">
        <!-- Må oppdateres for lokale verdi-->
        ...
        <metadata>           
            ...
            <xsl:call-template name="display">                
                ...
                <!-- Må oppdateres for lokal verdi se flub:getPrimoTypeFromRdfTypeLabel() for typer-->
                <xsl:with-param name="type"/>                               
            </xsl:call-template>
            
            <!-- variables for facets-->
                <!-- Må oppdateres for lokal verdi-->
            <xsl:variable name="rsrctype"/>
            ...
            <xsl:call-template name="facets">
                ...
                <!-- Må oppdateres for lokale verdi-->
                <xsl:with-param name="creatorcontrib"/>
            ...
            <xsl:call-template name="links">
                ...
                <!-- Må oppdateres for lokal verdi bruk flub:subfieldSetDisplayAndUrl('Lenketekts', "Lenke")-->
                <xsl:with-param name="linktorsrc"/>
            </xsl:call-template>
